...
## 设置一下仅自己可见直接全投了，放心看教程视频(･∀･)妈妈再也不用担心我的学习✧(≖ ◡ ≖✿)
...
禁止商业，自用的话随意。二改了记得写我名字顺便喊我一声，让我瞅瞅你的（嘻嘻）

## 原作者的碎碎念
tasks.length检测有点小bug，修了一下。刚进去菜单看到检测到0任务是正常的，不用管，直接点一键全部设置就行，点了以后就可以正常显示稿件量了。

批量立即投稿功能已修复，可以按照顺序投稿了。
不过b站过审也要时间，不同稿件会因为审核时间差导致其在个人中心的顺序和上传顺序不同。这是正常的

分区我默认选的绘画（因为我写这个脚本的目的是存绘画教程），找不到这个分区就会用一个默认分区。所以你在日志里面可能会看到有关绘画的语句。

希望各位使用愉快ε=ε=(ノ≧∇≦)ノ
觉得有帮助可以给我一个star吗，谢谢喵٩(๛ ˘ ³˘)۶❤
